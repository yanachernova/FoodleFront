...
const ModalRegisterBusiness = props => {
        ...
        <div className="modal fade" id="modal_register" tabIndex="-1" role="dialog"
            ...
            <div className="modal-dialog" role="document">
                <div className="modal-content">
                    ...
                    <div>{store.errorRegisterBusinessConsumer.msg}</div>
                    <div className="form-group">
                            <label htmlFor="username" className="form-label text-muted">Full Name:</label>
                            <input type="text" name="name" onChange={e => actions.handleChange(e)} className="form-control"></input>
                        </div>
                        <div className="form-group">
                    ...
                    <div className="modal-footer d-flex justify-content-end">
                        <button type="button" className="btn btn-primary mr-1" onClick={() =>actions.registerBusinessConsumerPost()} data-dismiss="modal">Register</button>
